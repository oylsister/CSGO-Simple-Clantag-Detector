...
{
	g_dVersion = CreateConVar("sm_clantag_detect_version", PLUGIN_VERSION, "ClanTag Detector Version");
	g_dClanTag = CreateConVar("sm_clantag_detect", "[SM]", "Specific the clantag that you want to print message to them.");
	AutoExecConfig(true, "sm_clantag_detect");
}

public void OnMapStart()
{
	g_dClanTag.GetString(SpecificClanTag, sizeof(SpecificClanTag));
}
